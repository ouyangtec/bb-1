...
<meta charset="UTF-8">
<title>锁屏休息</title>
<link href="/wang/Public/Admin/images/dsc.png" type="image/x-icon" rel="shortcut icon">
	<script type="text/javascript" src="/wang/Public/Admin/js/jquery.min.js"></script>
	<script type="text/javascript" src="/wang/Public/layer/layer.js"></script>
	<link href="/wang/Public/Admin/css/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
	<style>
		a{
			font-size: 12px;
			color: white;
		...
		.lock-screen {
			background:#02bac6 url("/wang/Public/Admin/img/lock-bg.jpg");
...
<div class="lock-wrapper">
	...
	<div class="lock-box text-center">
		<img src="/wang/Public/Admin/images/dsc.png" alt="lock avatar"/>
		<h1>后台系统</h1>
